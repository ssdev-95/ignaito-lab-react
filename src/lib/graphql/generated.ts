...
export type QueryAllLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, title: string, availableAt?: any | null, lessonType: LessonType, slug: string }> };
