...
export function Home() {
  return (
		<>
			<main
				className="w-full xl:ml-auto flex flex-col lg:flex-row justify-between py-32 bg-banner bg-[top_center] bg-no-repeat bg-cover"
			>
				<section className="lg:flex-[0.6] px-14">
					...
					<p className="text-gray-300 mb-16">In only one week you'll dominate by doing on of most used techs with high demand to acess the best job opportunities.</p>
				</section>
				<form className="w-full lg:w-132 lg:h-fit bg-gray-600 border-0 lg:border-[1px] border-gray-300 rounded-md px-16 py-4 lg:p-4 flex flex-col gap-4">
