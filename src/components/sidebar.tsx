...
export function Sidebar({
	...
	return (
		<aside className={["md:block w-full md:w-[358px] static mb:fixed bg-gray-600 px-8 mb:h-full mb:py-[calc(4.35rem+1px)] transition-all smooth duration-700 z-50 overflow-y-auto", `${isOpen ? "right-0" : "mb:right-out"}`].join(" ")}>
